...
def esm2_t6_8M_UR50D():
    ...
    # return load_model_and_alphabet_local("/nvme/xusheng1/Linglin/esm-main/pre_train_weight/esm2_t6_8M_UR50D.pt")
...
def esm2_t30_150M_UR50D():
    ...
    # return load_model_and_alphabet_local("esm2_t30_150M_UR50D")
